...
public class SoundManager {				// a Singleton class
	...
	private SoundManager () {
		...
		Clip clip = loadClip("nicemusic.wav");	// played from start of the game
		clips.put("background", clip);

		clip = loadClip("HitSound.wav");	// played when the ball hits slider or brick
		clips.put("hit", clip);

		clip = loadClip("AppearSound.wav");	// played when an alien is regenerated at the top of the JPanel
		clips.put("appear", clip);

		clip = loadClip("splash.wav");	// played when an ball is dropped
		clips.put("lose", clip);

		clip = loadClip("Game-Over.wav");	// played when game is lost
		clips.put("gover", clip);

		clip = loadClip("Dance_Powder.wav");	// played when game is won
		clips.put("win", clip);
	}
